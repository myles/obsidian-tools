...
from obsidian_tools.toolbox.library.models import Person, Track, Vinyl
...
def discogs_release_data_to_dataclass(release_data: Dict[str, Any]) -> Vinyl:
    """
...
def build_vinyl_note(vinyl_record: Vinyl) -> str:
    """
